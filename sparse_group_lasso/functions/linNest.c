...
// nrow = int32(nrow);
// ncol = int32(ncol);
// X = coder.nullcopy(zeros(nrow, ncol, 'double'));
// y = zeros(nrow, 1, 'double');
// index = zeros(ncol, 1, 'int32');
// numGroup = int32(numGroup);
...
// step = 0;
// reset = int32(0);
// code(X, y, index, rangeGroupInd, groupLen, lambda1, lambda2, 
//     innerIter, outerIter, thresh, outerThresh, eta, gamma, step, reset
#define P_X                 0
#define P_Y                 1
#define P_INDEX             2
