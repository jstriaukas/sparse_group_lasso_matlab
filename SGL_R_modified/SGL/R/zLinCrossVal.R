linCrossVal<-
function(data, index, nfold = 10, nlam = 20, min.frac = 0.05, alpha = 0.95,lambdas = NULL, thresh = 0.0001, maxit = 10000, gamma = 0.8, verbose = TRUE, step = 1, reset = 10, block.cv = FALSE){
